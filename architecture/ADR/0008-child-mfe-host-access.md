...
* Good, because the child-facing bridge stays at exactly four capability methods and two identity properties no matter how deep the nesting, since the inbound bridge that carries propagation and escalation is registry-internal and never exposed to child code.
