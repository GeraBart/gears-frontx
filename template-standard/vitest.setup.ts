...
//
// Shared Vitest test setup for template-standard and every project scaffolded
...
// `vitest.setup.ts`, not a shared import: template-standard is a
...
// template-standard only, so Vite/Vitest would reject a `/@fs` read one level
